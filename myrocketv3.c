...
void display1()
{
	...
	drawText(10, 450, 1, 0, 0.2, d, "PROJECT THEME: ");
	drawText(180, 450, 0.8, 0, 0.2, d, "WAR AND PEACE");

	drawText(10, 400, 1, 0, 0.2, d, "PROJECT TITLE: ");
	drawText(180, 400, 0.8, 0, 0.2, d, "ROCKET LAUNCH VISUALISATION");

	drawText(10, 320, 0.5, 0, 0.1, d, "ARSALAN ANWAR");
	drawText(200, 320, 0.5, 0, 0.1, d, "(1BI16CS025)");

	drawText(10, 290, 0.5, 0, 0.1, d, "DHANUSH R");
	drawText(200, 290, 0.5, 0, 0.1, d, "(1BI16CS043)");

	drawText(10.0, 230.0, 1, 0, 0, d, "UNDER THE GUIDENCE OF");
	drawText(10.0, 200.0, 0, 0, 1, d, "Prof.SHOBHA V");

	drawText(10.0, 170.0, 0, 0, 1, d, "Associate Professor, Dept of CSE");
	drawText(10.0, 140, 0, 0, 1, d, "BIT, Bangalore");
