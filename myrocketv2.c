...
void display1()
{
	...
	drawText(100, 450, 1, 0, 0.2, d, "PROJECT THEME: ");
	drawText(200, 450, 0.8, 0, 0.2, d, "WAR AND PEACE");

	drawText(100, 400, 1, 0, 0.2, d, "PROJECT TITLE: ");
	drawText(200, 400, 0.8, 0, 0.2, d, "ROCKET LAUNCH VISUALISATION");

	drawText(400, 250, 0.5, 0, 0.1, d, "ARSALAN ANWAR");
	drawText(400, 200, 0.5, 0, 0.1, d, "(1BI16CS025)");

	drawText(400, 150, 0.5, 0, 0.1, d, "DHANUSH R");
	drawText(400, 100, 0.5, 0, 0.1, d, "(1BI16CS043)");

	drawText(300.0, 350.0, 1, 1, 1, d, "UNDER THE GUIDENCE OF");
	drawText(300.0, 290.0, 1, 1, 0, d, "Prof.SHOBHA V");

	drawText(300.0, 260.0, 1, 1, 0, d, "Associate Professor, Dept of CSE");
	drawText(300.0, 230, 1, 1, 0, d, "BIT, Bangalore");

	drawText(300, 150, 0, 1, 0, d, "PRESS '1' TO START");
...
void win1() {
	...
	rocket();
	isro();
	drawText(250, 50, 1, 0, 0, 0, "Enter '2' to launch the rocket");
	glFlush();
	glutSwapBuffers();
}
...
glClearColor(0.196078  ,0.6 ,0.8,1.0);
	...
	for(i=0;i<=700;i++)
	{
		...
		for(j=0;j<=500000;j++)
		;
		//drawText(250, 75, 1, 0, 0, 0, "Rocket Launched");
		//drawText(250, 50, 1, 0, 0, 0, "Enter '3' to go to space");
		glFlush();
		glutSwapBuffers();
		glutPostRedisplay();	
	}
...
/*void win3() {
	...
	drawText(1150, 50, 0, 0, 0, 0, "Enter '4' to continue ");
	glFlush();
...
/*void win4() {
	...
	mouse(-490, 0);
	cat4(50, 60);
	drawText(1150, 50, 0, 0, 0, 0, "Enter '5' to continue ");
	glFlush();
}
...
void win7() {
	...
	drawText(600, 550, 0.5, 0, 0.1, d, "There was finally peace between tom and jerry!");
	drawText(720, 520, 0.5, 0, 0.1, d, "THE END");
	glFlush();
}*/
